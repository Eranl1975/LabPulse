...
export default function EmailProcedureDialog({ procedure, generatedAt, onClose }: Props) {
  const defaultSubject = `LabPulse Cleaning Procedure – ${procedure.manufacturer}${procedure.model !== 'General' ? ` ${procedure.model}` : ''}`;
  ...
  const handleSend = useCallback(async () => {
    ...
    try {
      const res = await fetch('/api/cleaning-procedure/email', {
        method: 'POST',
  ...
  }, [email, subject, message, procedure, generatedAt, defaultSubject, sending]);
